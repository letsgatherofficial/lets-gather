...
export type Database = {
  public: {
    Tables: {
      profiles: {
        Row: { id: string; full_name: string; phone: string | null; email: string | null; role: UserRole; created_at: string };
        Insert: { id: string; full_name: string; phone?: string | null; email?: string | null; role?: UserRole; created_at?: string };
    ...
    Functions: {
      assign_next_agent: {
        Args: { p_is_time_sensitive: boolean };
        Returns: string | null;
      };
